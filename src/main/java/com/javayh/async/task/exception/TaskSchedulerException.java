package com.javayh.async.task.exception;
...
public class TaskSchedulerException extends RuntimeException {
     ...
     * @since 1.7
     */
    protected TaskSchedulerException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
